...
int main(int argc, char** argv)
{
    ...
    // file to write times too
    FILE* fout;
    fout = fopen("thread_nums", "a");
...
int cg_parallel(unsigned int* csr_row_ptr, unsigned int* csr_col_ind,
       double* csr_vals, int m, int n, int nnz,
...
void verify_cg(int* row_ptr, int* col_ind, double* vals, int m, int n, int nnz, double* x, double* b)
{
