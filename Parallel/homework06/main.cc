...
int main(int argc, char** argv)
{
    ...
    test_dot(n, b, b1, &d_b, &d_b1, &z1, &z2);
    ...
    */
    ...
    allocate_data_gpu(x, b, &dx, &db, &drk, &dpk, &dap, &z1, &z2, m, n);
    // ----------------------------------------------------------------- 
    ...
    // ----------------------------------------------------------------- 
    // Execute CG
    fprintf(stderr, "Executing Conjugate Gradient using CSR... ");
    t0 = ReadTSC();
    ...
    free(col_ind);
    free(val);
    free_gpu(drp, dci, dec, dev, dx, db, drk, dpk, dap, z1, z2);
    // ----------------------------------------------------------------- 
